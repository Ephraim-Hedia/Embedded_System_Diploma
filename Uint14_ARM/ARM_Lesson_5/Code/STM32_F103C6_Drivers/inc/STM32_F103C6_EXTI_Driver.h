...
typedef struct
{
	...
	uint8_t 			IRQ_EN		;		//Enable or Disable the EXTI_IRQ (That will Enable the IRQ Mask in EXTI and Also on NVIC interrupt)
											//This parameter must be set based on @ref EXTI_IRQ _define
